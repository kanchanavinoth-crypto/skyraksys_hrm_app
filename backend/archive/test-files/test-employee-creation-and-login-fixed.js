...
// Test data for creating a new employee
...
async function createEmployee() {
  try {
    ...
    console.log('📋 Employee Data:', {
      ...
      passwordLength: testEmployeeData.password.length
    });
    ...
    if (response.data && response.data.success) {
      ...
      console.log('👤 Created Employee Details:', {
        ...
        credentialsEmail: response.data.credentials?.email
      });
...
async function testNewUserLogin() {
  try {
    ...
    console.log('- Email sent to API:', testEmployeeData.email);
    console.log('- Password sent to API:', testEmployeeData.password);
...
async function runCompleteTest() {
  ...
  try {
    ...
    if (!userLoginSuccess) {
      console.log('\n💥 Test failed at user login step - investigating...');
      
      // Try to diagnose the issue
      console.log('\n🔧 Diagnostic Information:');
      console.log('- Employee creation response had success:', !!createdEmployeeData.success);
      console.log('- Credentials in response:', !!createdEmployeeData.credentials);
      console.log('- User data in response:', !!createdEmployeeData.data?.user);
