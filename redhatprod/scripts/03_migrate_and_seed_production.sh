...
if [ "$USERS_FINAL" -gt 0 ]; then
    ...
    if [ "$USERS_FINAL" -ge 5 ]; then
        ...
        echo "HR:        hr@example.com / ${DEFAULT_PASSWORD}"
        echo "Manager:   lead@example.com / ${DEFAULT_PASSWORD}"
        echo "Employee1: employee1@example.com / ${DEFAULT_PASSWORD}"
        echo "Employee2: employee2@example.com / ${DEFAULT_PASSWORD}"
        echo ""
        
        {
            ...
            echo "Manager:   lead@example.com"
            echo "Employee1: employee1@example.com"
            echo "Employee2: employee2@example.com"
            echo ""
        } >> "$REPORT_FILE"
    fi
fi
